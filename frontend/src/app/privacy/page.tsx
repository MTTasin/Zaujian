...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="গোপনীয়তা" title="গোপনীয়তা নীতি" updated="১৭ জুলাই, ২০২৬">
      ...
      <LegalSection heading="ওয়েবসাইট ব্যবহারের পরিসংখ্যান">
        <p>
          ওয়েবসাইটটি কীভাবে ব্যবহৃত হচ্ছে তা বোঝার জন্য আমরা নিজস্ব সার্ভারে সাধারণ
          পরিসংখ্যান রাখি — কোন পেজ দেখা হয়েছে, কোন পণ্যে আগ্রহ বেশি, এবং ডিভাইস
          মোবাইল না কম্পিউটার। এর জন্য আপনার ব্রাউজারে একটি এলোমেলো নম্বর রাখা হয়।
        </p>
        <p>
          <strong className="text-foreground">এতে আপনার নাম, ফোন নম্বর বা ঠিকানা থাকে না</strong>{" "}
          এবং আমরা আপনার IP ঠিকানা সংরক্ষণ করি না। এই তথ্য ৯০ দিন পর মুছে ফেলা হয়;
          এরপর কেবল দিনভিত্তিক মোট সংখ্যা থাকে।
        </p>
      </LegalSection>
